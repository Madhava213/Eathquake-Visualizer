...
export class EarthquakeMarker extends gfx.MeshInstance
{
    ...
    constructor(mapPosition: gfx.Vector3, globePosition: gfx.Vector3, record: EarthquakeRecord, duration: number, morphVal: number)
    {
        ...
        this.position.lerp(this.mapPosition,this.globePosition,morphVal);
